...
<head>
    <meta charset="UTF-8">
    <link rel="icon" type="image/png" href="<?php echo URLROOT; ?>/assets/images/landing/homepage/bookhive.png">
...
<body>
    ...
    <div class="body-container">
        <img id="bcnd" src="<?php echo URLROOT; ?>/assets/images/landing/homepage/landing.jpg">
    </div>

    <section class="welcombox">
        <h1>Welcome to BookHive - Your Online Bookstore</h1>
        <p>Here we introducing a web-based Platform "BookHive Bookstore" : <br>Dedicated to Providing a Wide Range of
    ...
    <section id="publishing" class="publishing">
        ...
        <div class="event">
            ...
            <video id="videoPlayer" width="60%" height="auto" controls
                ...
                <source src="<?php echo URLROOT; ?>/assets/images/landing/homepage/book.mp4" type="video/mp4">
            </video>
        </div>
    </section>
    <br><br>
    ...
    <section id="events" class="events">
        ...
        <div class="event">
            ...
            <img src="<?php echo URLROOT; ?>/assets/images/landing/homepage/event.jpg" alt="Event 1">
        </div>
    </section>
    ...
    <footer>
        <div>
            <p>Privacy Policy : All content included on this site, such as text, graphics, logos, button icons, images,
                audio clips, digital downloads, data compilations, and software, is the property of BOOKHIVE or its
                content suppliers and protected by Sri Lanka and international copyright laws...</p>
        </div>
        <div>
            <p id="copyright" style=" color: #141414;">&copy; 2024 BookHive. All rights reserved.</p>
        </div>
    </footer>
